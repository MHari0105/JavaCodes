 ...
 * Since it creates object it falls in creation design pattern
 * Factory pattern has two important element in its design.

 * 1. Interface/Abstract class : This is base element for which we are making factory ie we are going to get object of this type
 ...
 * MacOperatingSystem. Now your caller is automatically extended this facility of third type , also we have taken responsibility og
 * creating of object.
...
//    }
    return switch (type) {
      case "WINDOWS" -> new WindowsOS(version, architecture);
      case "LINUX" -> new LinuxOS(version, architecture);
